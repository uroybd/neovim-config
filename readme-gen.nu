...
def generate_card [spec] {
  return $'<a target="_blank" src="($spec.value.src)"><img src="($spec.value.src | str replace -r '^https:\/\/github\.com' 'https://githubcard.com').svg?d=V24f0SDc" width="45%" alt="($spec.key)" /></a>'
}
